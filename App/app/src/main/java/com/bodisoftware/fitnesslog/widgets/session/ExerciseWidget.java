...
public class ExerciseWidget extends LinearLayout {
    ...
    public void addSet(final int setNumber, final String setHeader, final float weight, final int reps ) {
        SetWidget setWidget = new SetWidget(mContext); //@todo: move to builder pattern?
        setWidget.setSetNumber(setNumber);
    ...
    public ArrayList<Set> getSets() {
        ...
        for (SetWidget setWidget : mLstSetWidgets) {
            Set set = new Set();
            set.setNumber = setWidget.getmSetNumber();
